                ...
                <SidebarMenuItem key={item.title}>
                  ...
                  >
                    <NavLink 
                      to={item.url} 
                      className={`
                        flex items-center py-2 transition-all duration-200 ease-in-out
                    ...
                    >
                      ...
                      <span className={`
                        ...
                        ${isCollapsed 
                          ? 'opacity-0 -translate-x-4 w-0 overflow-hidden whitespace-nowrap' 
      ...
      <SidebarFooter className="border-t border-sidebar-border p-4">
        <div className="space-y-3">
          ...
          `}>
            ...
            <span className={`
              text-sm text-sidebar-foreground transition-all duration-200 ease-in-out
              ${isCollapsed 
                ? 'opacity-0 -translate-x-4 w-0 overflow-hidden whitespace-nowrap' 
